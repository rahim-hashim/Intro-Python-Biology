...
| 7/30 | 5 | APIs, Machine Learning | Jonathan | - | [Lesson 5](https://github.com/rahim-hashim/Intro-Python-Biology/blob/main/Notebooks/Intro-Python_Lesson-5.ipynb) | Choose a [Public API](https://github.com/public-apis/) or another dataset for your final project | - |
